...
const QUICK_ACTIONS: QuickAction[] = [
  { id: 'build', label: 'What can you build?' },
  { id: 'projects', label: 'Show me the systems' },
  { id: 'process', label: 'How do you work?' },
...
function getSmartReply(rawText: string): string {
  ...
  if (containsAny(text, ['hello', 'hi', 'hey', 'good morning', 'good evening', 'اهلا', 'أهلا', 'السلام', 'مرحبا', 'هاي'])) {
    return replyInArabic
      ? 'أهلًا! أنا مساعد أبو العلا. أقدر أعرّفك بسرعة على عبد الرحمن، نوع الأنظمة التي يبنيها، المشاريع المعروضة، طريقة العمل، أو طرق التواصل.'
      : 'Hi! I’m Abouelella’s assistant. I can help you explore Abdelrahman’s work, systems, process, technical stack, and contact options.';
  }
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'bot',
      text: "Hi, I’m Judy — Abouelella’s portfolio assistant. Ask me about Abdelrahman’s systems, process, technical stack, or how to start a project.",
    }
  ]);
          ...
          >
            <div className="p-4 border-b-2 border-border bg-surface flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-sm text-foreground uppercase tracking-widest">Judy Assistant</h3>
