  ...
  return (
    <section className="py-32 relative overflow-hidden bg-background" dir="rtl">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <span className="text-[10px] tracking-[0.2em] uppercase font-bold text-ink-blue mb-8 block">التنفيذ</span>
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold font-serif mb-10 leading-[1.1] tracking-tight text-foreground relative inline-block">
            ...
            >
              <span className="relative z-10">محتاج يتفصّل؟</span>
              <motion.svg
                aria-hidden="true"
          ...
          <p className="text-xl md:text-2xl text-foreground/90 mb-16 font-medium max-w-3xl mx-auto leading-relaxed mt-6">
            خلّينا نحوله لبرنامج عملي، مصمم على طريقة شغلك، ينظم التفاصيل، يوضح الصورة، ويساعد فريقك يشتغل بكفاءة أعلى.
          </p>
