    ...
    <section className="py-32 bg-background relative overflow-hidden" dir="rtl">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-24">
          <span className="text-[10px] tracking-[0.2em] uppercase font-bold text-foreground/40 mb-6 block">التقنيات</span>
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold font-serif mb-8 tracking-tight">الأدوات والأساس التقني</h2>
          <p className="text-lg md:text-xl text-foreground/60 font-light max-w-2xl mx-auto leading-relaxed">
            أدوات وأنماط وممارسات تسليم أستخدمها لبناء منتجات برمجية كاملة من البنية الخلفية حتى الواجهة.
          </p>
        </div>
            ...
            >
              ...
              <ul className="space-y-5">
                {cat.skills.map((skill, j) => (
                  <li key={j} className="text-foreground/60 text-sm flex items-center before:content-[''] before:w-1.5 before:h-px before:bg-foreground/30 before:ml-4 font-light tracking-wide">
                    {skill}
                  </li>
                ))}
              </ul>
